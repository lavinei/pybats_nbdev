...
__all__ = ['pkg_data_dir', 'beta_approx', 'gamma_approx', 'gamma_alpha_approx', 'pois_alpha_param', 'gamma_solver',
           'beta_solver', 'conj_params', 'bern_conjugate_params', 'pois_conjugate_params', 'bin_conjugate_params']
...
from pybats.shared import trigamma
