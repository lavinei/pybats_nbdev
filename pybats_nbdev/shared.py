...
__all__ = ['load_sales_example', 'load_sales_example2', 'load_dcmm_latent_factor_example',
           'load_dbcm_latent_factor_example', 'load_us_inflation', 'load_us_inflation_forecasts',
           'load_standard_holidays', 'cov2corr']
...
def cov2corr(cov):
    """
    Transform a covariance matrix into a correlation matrix. Useful for understanding the coefficient correlations.
    """
